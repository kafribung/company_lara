                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="table-responsive">
                                    <form action="/motivation/{{$data->id}}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="owner">Owner</label>
                                            <input type="text" name="owner" class="form-control" id="owner" placeholder="owner" value="{{$data->owner}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="profession" class="form-control" id="profession" placeholder="profession" value="{{$data->profession}}">
