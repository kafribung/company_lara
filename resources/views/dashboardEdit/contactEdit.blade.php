                                ...
                                <div class="table-responsive">
                                    <form action="/contact/{{$data->id}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" class="form-control" id="address" placeholder="address" autocomplete="off" value="{{$data->address}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="handpone" class="form-control" id="handpone" placeholder="handpone" autocomplete="off" value="{{$data->handpone}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="twitter" class="form-control" id="twitter" placeholder="twitter" autocomplete="off" value="{{$data->twitter}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fb" class="form-control" id="fb" placeholder="fb" autocomplete="off" value="{{$data->fb}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="instagram" class="form-control" id="instagram" placeholder="instagram" autocomplete="0" value="{{$data->instagram}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="linkedin" class="form-control" id="linkedin" placeholder="linkedin" autocomplete="0" value="{{$data->linkedin}}">
