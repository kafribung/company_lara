    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark active" href="/comment" aria-expanded="false"><i
                                        ...
                                        <tbody>
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->message}}</td>
                                                    <td>
                                                        <a href="/comment/{{$data->id}}" class="btn btn-danger"  onclick="event.preventDefault();
                                                            document.getElementById('delete').submit();"><i class="fa fa-trash"></i></a>

                                                        <form id="delete" action="/comment/{{$data->id}}" method="POST" style="display: none;">
                                                            @csrf
