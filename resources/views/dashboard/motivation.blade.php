...
@section('title', 'Motivation - Dashboard')
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <a href="/motivation/create" class="btn btn-circle btn-lg btn-success waves-effect waves-dark float-right">+</a>
                                        ...
                                        <tbody>
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/motivation/{{$data->id}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="/motivation/{{$data->id}}" class="btn btn-danger"  onclick="event.preventDefault();
                                                            document.getElementById('delete').submit();"><i class="fa fa-trash"></i></a>

                                                        <form id="delete" action="/motivation/{{$data->id}}" method="POST" style="display: none;">
                                                            @csrf
