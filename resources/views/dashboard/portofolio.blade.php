...
@section('title', 'Portofolio - Dashboard')
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Portofolio</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Portofolio Table</h4>

                                <!-- Button trigger modal -->
                                <a href="/portofolio/create" class="btn btn-circle btn-lg btn-success waves-effect waves-dark float-right">+</a>
                                        ...
                                        <tbody>
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->title}}</td>
                                                    <td><img src="{{asset('storage/portofolio/' . $data->image)}}" alt="Error" width="100" height="100" title="{{$data->title}}"></td>
                                                    <td>
                                                        <a href="/portofolio/{{$data->id}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="/portofolio/{{$data->id}}" class="btn btn-danger"  onclick="event.preventDefault();
                                                            document.getElementById('delete').submit();"><i class="fa fa-trash"></i></a>

                                                        <form id="delete" action="/portofolio/{{$data->id}}" method="POST" style="display: none;">
                                                            @csrf
