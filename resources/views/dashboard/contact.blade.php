        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="/hobby" aria-expanded="false"><i
                            class="mdi mdi-camera"></i><span class="hide-menu">Hobby</span></a>
                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <a href="/contact/create" class="btn btn-circle btn-lg btn-success waves-effect waves-dark float-right">+</a>
                                        ...
                                        <tbody>
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->linkedin}}</td>
                                                    <td>
                                                        <a href="/contact/{{$data->id}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="/contact/{{$data->id}}" class="btn btn-danger"  onclick="event.preventDefault();
                                                            document.getElementById('delete').submit();"><i class="fa fa-trash"></i></a>

                                                        <form id="delete" action="/contact/{{$data->id}}" method="POST" style="display: none;">
                                                            @csrf
